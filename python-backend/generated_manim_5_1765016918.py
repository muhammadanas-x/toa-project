...
class PolynomialOddEven(Scene):
    def construct(self):
        axes = Axes(x_range=[-3, 3, 1], y_range=[-10, 10, 2], x_length=7, y_length=5, tips=True)
        ...
        graph_fx_label = axes.get_graph_label(graph_fx, label='f(x) = x^3 + x^2')
        ...
        result_text = Text("x^3 + x^2 is neither even nor odd.")
