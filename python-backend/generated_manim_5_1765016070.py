...
class FractionSqrtDemo(Scene):
    def construct(self):
        axes = Axes(x_range=[-4, 4, 1], y_range=[-1, 1, 0.2], x_length=8, y_length=5, tips=True)
